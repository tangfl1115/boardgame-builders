// v1.2.0 - 2026-07-09
// Changelog:
// - 全面數學式化：移除所有純中文字名詞卡（如「相反數」、「絕對值」），全部改為極簡的數學題目/算式（如 -(-5) = ?、|-3| = ?）。
// - 每張牌都是一個直覺、有明確標準答案的極簡數學題。
...
export const versions = {
    "anomia-math-7a-read": {
        ...
        rules: [
            ...
            { title: "🗣️ 對決運算", desc: "對決雙方必須看著「對方的卡牌」，迅速算出算式答案（小括號內為正確解答）。先喊出正確答案者獲勝！" },
    ...
    "anomia-math-7a-duel": {
        ...
        description: "國中一年級上學期。對決時玩家需要唸出符合對方卡片「數學主題類別」的「另一個」數學概念或公式！",
        referenceGame: "字字轉機 (Anomia)",
        backColor: "#1e3a8a",
        backBorder: "#172554",
        pattern: "bg-grid",
    ...
    "anomia-math-7b-read": {
        ...
        rules: [
            ...
            { title: "📦 遊戲準備", desc: "將 48 張數學牌與 6 張萬能牌混合洗勻，面朝下放置中央作為牌堆。玩家輪流翻開一張牌，置於自己面前。" },
            { title: "⚔️ 觸發對決", desc: "當有兩位玩家面前翻開的卡牌上，幾何圖形（顏色與標記）完全相同時，立即觸發「對決」！" },
            { title: "🗣️ 對決運算", desc: "對決雙方必須看著「對方的卡牌」，迅速算出算式答案（小括號內為解答）。先喊出正確答案者獲勝！" },
            { title: "⛓️ 連鎖匹配", desc: "當贏家移走輸家的卡牌後，輸家面前可能會露出下一張舊卡牌。如果該圖案又與場上其他人相同，會立即觸發新的連鎖對決！" },
            { title: "🌟 萬能牌 (Wild)", desc: "若翻出萬能牌，置於場中央。當有玩家卡牌的圖形符合萬能牌上顯示的兩個圖案之一時，兩位玩家即使圖案不同也會觸發對決。" }
        ]
    },
