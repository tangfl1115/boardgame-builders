// v1.1.0 - 2026-07-09
// Changelog:
// - 全面去申論化：將「科學記號」、「質數」等所有抽象名詞全部替換為極簡問答或是非題。
// - 支援指數格式化：採用 caret ^ 符號（如 2^3 = ?），網頁端會自動渲染為美觀的上方乘方字體。
// - 隱藏卡片答案：卡片正面無答案干擾。
...
export const versions = {
    "anomia-math-7a-read": {
        ...
        description: "國中一年級上學期。包含整數、分數、因數倍數、科學記號與一元一次方程式。對決時需迅速回答卡片上的是非題，或快速算出極簡數學題答案！",
        ...
        cards: [
            // ==================== Circle (整數運算) ====================
            { id: "card-m1-1", name: "-5的相反數？", count: 1, value: "circle", shape: "circle", hex: "#ef4444", summary: "整數的運算 (Integer Operations)", effect: "5" },
            ...
            // ==================== Square (指數與科學) ====================
            { id: "card-m1-7", name: "100 = 10^2 對嗎？", count: 1, value: "square", shape: "square", hex: "#3b82f6", summary: "指數與科學記號 (Exponents)", effect: "對" },
            ...
            { id: "card-m1-18", name: "12 = 2^2 * 3 對嗎？", count: 1, value: "triangle", shape: "triangle", hex: "#22c55e", summary: "質因數分解 (Factorization)", effect: "對" },

            // ==================== Rectangle (分數運算) ====================
            { id: "card-m1-19", name: "2/4是最簡分數嗎？", count: 1, value: "rectangle", shape: "rectangle", hex: "#eab308", summary: "分數的運算 (Fraction Operations)", effect: "不是" },
            ...
            { id: "card-m1-29", name: "3x + 5的常數項是？", count: 1, value: "rhombus", shape: "rhombus", hex: "#a855f7", summary: "代數化簡題 (Simplification)", effect: "5" },
            { id: "card-m1-30", name: "5x - x = ?", count: 1, value: "rhombus", shape: "rhombus", hex: "#a855f7", summary: "代數化簡題 (Simplification)", effect: "4x" },

            // ==================== Trapezoid (方程式與求解) ====================
            { id: "card-m1-31", name: "等式兩邊加同數還相等嗎？", count: 1, value: "trapezoid", shape: "trapezoid", hex: "#f97316", summary: "一元一次方程式 (Linear Equations)", effect: "相等" },
            { id: "card-m1-32", name: "方程式+3移到右邊變？", count: 1, value: "trapezoid", shape: "trapezoid", hex: "#f97316", summary: "一元一次方程式 (Linear Equations)", effect: "-3" },
            ...
            // ==================== Ellipse (數線與絕對值) ====================
            { id: "card-m1-37", name: "原點的坐標是？", count: 1, value: "ellipse", shape: "ellipse", hex: "#ec4899", summary: "數線與絕對值 (Number Lines)", effect: "0" },
            ...
            { id: "card-m1-40", name: "0的絕對值是？", count: 1, value: "ellipse", shape: "ellipse", hex: "#ec4899", summary: "數線與絕對值 (Number Lines)", effect: "0" },
            { id: "card-m1-41", name: "a*(b+c) = ab+ac 對嗎？", count: 1, value: "ellipse", shape: "ellipse", hex: "#ec4899", summary: "分配律規則 (Distributive Property)", effect: "對" },
            ...
            { id: "card-m1-47", name: "1/2和1/3通分後分母是？", count: 1, value: "pentagon", shape: "pentagon", hex: "#06b6d4", summary: "分數通分題 (Fraction Denominator)", effect: "6" },
            { id: "card-m1-48", name: "1/2擴分後等於2/4對嗎？", count: 1, value: "pentagon", shape: "pentagon", hex: "#06b6d4", summary: "分數擴分題 (Fraction Expansion)", effect: "對" },
        ...
        rules: [
            { title: "🎯 遊戲目標", desc: "當翻出相同幾何圖形（或符合萬能牌）時，比對手搶先唸出對方卡牌上的數學概念答案，或快速算出口算題答案！" },
            ...
            { title: "🗣️ 對決運算", desc: "對決雙方必須看著「對方的卡牌」，迅速回答是非題或算出算式答案（小括號內為正確解答）。先喊出正確答案者獲勝！" },
    ...
    "anomia-math-7a-duel": {
        ...
        rules: [
            ...
            { title: "⛓️ 連鎖匹配", desc: "當贏家移走輸家的卡牌後，輸家面前可能會露出下一張舊卡牌。如果該圖案又與場上其他人相同，會立即觸發新的連鎖對決！" },
            { title: "🌟 萬能牌 (Wild)", desc: "若翻出萬能牌，置於場中央。當有玩家卡牌的圖形符合萬能牌上顯示的兩個圖案之一時，兩位玩家即使圖案不同會觸發對決。" }
        ]
    },
    "anomia-math-7b-read": {
        ...
        description: "國中一年級下學期。包含二元一次聯立方程式、直角坐標平面、比例（正反比）、一元一次不等式。對決時需迅速回答卡片上的是非題，或快速算出極簡坐標或未知數答案！",
        referenceGame: "字字轉機 (Anomia)",
        backColor: "#581c87",
        backBorder: "#3b0764",
        pattern: "bg-grid",
        cards: [
            ...
            { id: "card-m2-5", name: "x = 2y, x + y = 6 的解？", count: 1, value: "circle", shape: "circle", hex: "#f43f5e", summary: "聯立方程組求解 (Equation Solving)", effect: "x=4, y=2" },
            { id: "card-m2-6", name: "x - y = 0, x + y = 10", count: 1, value: "circle", shape: "circle", hex: "#f43f5e", summary: "聯立方程組求解 (Equation Solving)", effect: "x=5, y=5" },

            // ==================== Square (直角坐標系) ====================
            { id: "card-m2-7", name: "原點的坐標是？", count: 1, value: "square", shape: "square", hex: "#0ea5e9", summary: "直角坐標系 (Coordinate Plane)", effect: "(0, 0)" },
            { id: "card-m2-8", name: "(3, -4)在第四象限嗎？", count: 1, value: "square", shape: "square", hex: "#0ea5e9", summary: "直角坐標系 (Coordinate Plane)", effect: "是" },
            { id: "card-m2-9", name: "(2, 3) 在第一象限嗎？", count: 1, value: "square", shape: "square", hex: "#0ea5e9", summary: "直角坐標系 (Coordinate Plane)", effect: "是" },
            { id: "card-m2-10", name: "(-1, -5)在第三象限嗎？", count: 1, value: "square", shape: "square", hex: "#0ea5e9", summary: "直角坐標系 (Coordinate Plane)", effect: "是" },
            ...
            { id: "card-m2-16", name: "x = 0的圖形就是y軸嗎？", count: 1, value: "triangle", shape: "triangle", hex: "#10b981", summary: "方程式的圖形 (Graphs of Equations)", effect: "是" },
            ...
            // ==================== Rhombus (正比與反比) ====================
            { id: "card-m2-25", name: "y = 2x是正比嗎？", count: 1, value: "rhombus", shape: "rhombus", hex: "#8b5cf6", summary: "正比與反比 (Direct & Inverse)", effect: "是" },
            { id: "card-m2-26", name: "xy = 12是反比嗎？", count: 1, value: "rhombus", shape: "rhombus", hex: "#8b5cf6", summary: "正比與反比 (Direct & Inverse)", effect: "是" },
            { id: "card-m2-27", name: "y = -3x 是正比嗎？", count: 1, value: "rhombus", shape: "rhombus", hex: "#8b5cf6", summary: "正比與反比 (Direct & Inverse)", effect: "是" },
            { id: "card-m2-28", name: "x * y = 8 是反比嗎？", count: 1, value: "rhombus", shape: "rhombus", hex: "#8b5cf6", summary: "正比與反比 (Direct & Inverse)", effect: "是" },
            ...
            { id: "card-m2-34", name: "x - 1 > 3，解為？", count: 1, value: "trapezoid", shape: "trapezoid", hex: "#f97316", summary: "一元一次不等式 (Linear Inequalities)", effect: "x > 4" },
            { id: "card-m2-35", name: "2x > 6，解為？", count: 1, value: "trapezoid", shape: "trapezoid", hex: "#f97316", summary: "不等式的解 (Inequality Solutions)", effect: "x > 3" },
            { id: "card-m2-36", name: "-x > 2，解為？", count: 1, value: "trapezoid", shape: "trapezoid", hex: "#f97316", summary: "不等式的解 (Inequality Solutions)", effect: "x < -2" },

            // ==================== Ellipse (坐標軸與點距離) ====================
            { id: "card-m2-37", name: "y = 2, x + y = 5", count: 1, value: "ellipse", shape: "ellipse", hex: "#d946ef", summary: "聯立方程求解 (Equation Solving)", effect: "x = 3" },
            ...
            { id: "card-m2-40", name: "(3, 4)到x軸距離是？", count: 1, value: "ellipse", shape: "ellipse", hex: "#d946ef", summary: "坐標與軸距離 (Axes & Distances)", effect: "4" },
            ...
            { id: "card-m2-44", name: "x:y=2:3，則3x=2y對嗎？", count: 1, value: "pentagon", shape: "pentagon", hex: "#14b8a6", summary: "最簡整數比 (Simplest Ratio)", effect: "對" },
            { id: "card-m2-45", name: "y = 5x 的正比常數是？", count: 1, value: "pentagon", shape: "pentagon", hex: "#14b8a6", summary: "比例常數題 (Proportion Constants)", effect: "5" },
            { id: "card-m2-46", name: "xy = 10 的反比常數是？", count: 1, value: "pentagon", shape: "pentagon", hex: "#14b8a6", summary: "比例常數題 (Proportion Constants)", effect: "10" },
    ...
    "anomia-math-7b-duel": {
        ...
        description: "國中一年級下學期。對決時玩家需要唸出符合對方卡片「數學主題類別」的「另一個」數學公式或幾何幾何坐標概念！",
        referenceGame: "字字轉機 (Anomia)",
        backColor: "#581c87",
        backBorder: "#3b0764",
        pattern: "bg-grid",
        cards: [
            ...
            { id: "card-m2-2", name: "x=1,y=2時，x+y=?", count: 1, value: "circle", shape: "circle", hex: "#f43f5e", summary: "二元一次方程式 (Systems of Equations)", effect: "3" },
            { id: "card-m2-3", name: "x=3,y=1時，2x-y=?", count: 1, value: "circle", shape: "circle", hex: "#f43f5e", summary: "二元一次方程式 (Systems of Equations)", effect: "5" },
            { id: "card-m2-4", name: "x=2,y=5是x+y=7 the解嗎？", count: 1, value: "circle", shape: "circle", hex: "#f43f5e", summary: "二元一次方程式 (Systems of Equations)", effect: "是" },
            { id: "card-m2-5", name: "x = 2y, x + y = 6 的解？", count: 1, value: "circle", shape: "circle", hex: "#f43f5e", summary: "聯立方程組求解 (Equation Solving)", effect: "x=4, y=2" },
            { id: "card-m2-6", name: "x - y = 0, x + y = 10", count: 1, value: "circle", shape: "circle", hex: "#f43f5e", summary: "聯立方程組求解 (Equation Solving)", effect: "x=5, y=5" },
            { id: "card-m2-7", name: "原點的坐標是？", count: 1, value: "square", shape: "square", hex: "#0ea5e9", summary: "直角坐標系 (Coordinate Plane)", effect: "(0, 0)" },
            { id: "card-m2-8", name: "(3, -4)在第四象限嗎？", count: 1, value: "square", shape: "square", hex: "#0ea5e9", summary: "直角坐標系 (Coordinate Plane)", effect: "是" },
        ...
        rules: [
            ...
            { title: "📦 遊戲準備", desc: "將 48 張主題牌與 6 張萬能牌混合洗勻，面朝下放置中央作為牌堆。玩家輪流翻開一張牌，置於自己面前。" },
            { title: "⚔️ 觸發對決", desc: "當有雙方玩家面前翻開的卡牌上，幾何圖形（顏色與標記）完全相同時，立即觸發「對決」！" },
            { title: "🗣️ 類別對決", desc: "對決的兩人必須看對方的卡牌主題（如對手是 比例關係），迅速喊出符合該主題的另一個數學公式或幾何幾何坐標概念。先喊出者獲勝！" }
        ]
    }
};
