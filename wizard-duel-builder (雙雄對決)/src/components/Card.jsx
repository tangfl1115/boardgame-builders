        ...
        >
            ...
            >
                <p className={`
                    ...
                    ${isLargePrint ? 'text-4xl leading-relaxed whitespace-pre-line' : (isMediumPrint ? 'text-2xl leading-relaxed whitespace-pre-line' : 'text-[14px] leading-snug whitespace-pre-line')}
                `} style={{ color: '#0f172a' }}>
                    {card.effect}
                </p>
            </div>
