export const versions = {
    ...
    "anomia-read-int": {
        ...
        cards: [
            ...
            { id: "card-int-3", name: "father", count: 1, value: "one", shape: "circle", hex: "#ef4444", summary: "Family (家人)", effect: "父親" },
            { id: "card-int-4", name: "notebook", count: 1, value: "one", shape: "circle", hex: "#ef4444", summary: "School Supply (文具)", effect: "筆記本" },
            { id: "card-int-5", name: "pizza", count: 1, value: "one", shape: "circle", hex: "#ef4444", summary: "Food (食物)", effect: "披薩" },
            { id: "card-int-6", name: "doctor", count: 1, value: "one", shape: "circle", hex: "#ef4444", summary: "Job (職業)", effect: "醫生" },

            // ==================== Square (Blue, "two") ====================
            { id: "card-int-7", name: "bear", count: 1, value: "two", shape: "square", hex: "#3b82f6", summary: "Animal (動物)", effect: "熊" },
            { id: "card-int-8", name: "mother", count: 1, value: "two", shape: "square", hex: "#3b82f6", summary: "Family (家人)", effect: "母親" },
            { id: "card-int-9", name: "pencil case", count: 1, value: "two", shape: "square", hex: "#3b82f6", summary: "School Supply (文具)", effect: "鉛筆盒" },
            { id: "card-int-10", name: "cookie", count: 1, value: "two", shape: "square", hex: "#3b82f6", summary: "Food (食物)", effect: "餅乾" },
            { id: "card-int-11", name: "pants", count: 1, value: "two", shape: "square", hex: "#3b82f6", summary: "Clothing (衣物)", effect: "長褲" },
            { id: "card-int-12", name: "rocket", count: 1, value: "two", shape: "square", hex: "#3b82f6", summary: "Transportation (交通)", effect: "火箭" },

            // ==================== Triangle (Green, "three") ====================
            { id: "card-int-13", name: "tiger", count: 1, value: "three", shape: "triangle", hex: "#22c55e", summary: "Animal (動物)", effect: "老虎" },
            { id: "card-int-14", name: "strawberry", count: 1, value: "three", shape: "triangle", hex: "#22c55e", summary: "Fruit (水果)", effect: "草莓" },
            { id: "card-int-15", name: "brother", count: 1, value: "three", shape: "triangle", hex: "#22c55e", summary: "Family (家人)", effect: "兄弟" },
            { id: "card-int-16", name: "juice", count: 1, value: "three", shape: "triangle", hex: "#22c55e", summary: "Food (食物)", effect: "果汁" },
            { id: "card-int-17", name: "teacher", count: 1, value: "three", shape: "triangle", hex: "#22c55e", summary: "Job (職業)", effect: "老師" },
            { id: "card-int-18", name: "truck", count: 1, value: "three", shape: "triangle", hex: "#22c55e", summary: "Transportation (交通)", effect: "卡車" },

            // ==================== Rectangle (Yellow, "four") ====================
            { id: "card-int-19", name: "elephant", count: 1, value: "four", shape: "rectangle", hex: "#eab308", summary: "Animal (動物)", effect: "大象" },
            { id: "card-int-20", name: "watermelon", count: 1, value: "four", shape: "rectangle", hex: "#eab308", summary: "Fruit (水果)", effect: "西瓜" },
            { id: "card-int-21", name: "eraser", count: 1, value: "four", shape: "rectangle", hex: "#eab308", summary: "School Supply (文具)", effect: "橡皮擦" },
            { id: "card-int-22", name: "burger", count: 1, value: "four", shape: "rectangle", hex: "#eab308", summary: "Food (食物)", effect: "漢堡" },
            { id: "card-int-23", name: "driver", count: 1, value: "four", shape: "rectangle", hex: "#eab308", summary: "Job (職業)", effect: "司機" },
            { id: "card-int-24", name: "shorts", count: 1, value: "four", shape: "rectangle", hex: "#eab308", summary: "Clothing (衣物)", effect: "短褲" },

            // ==================== Rhombus (Purple, "five") ====================
            { id: "card-int-25", name: "monkey", count: 1, value: "five", shape: "rhombus", hex: "#a855f7", summary: "Animal (動物)", effect: "猴子" },
            { id: "card-int-26", name: "pineapple", count: 1, value: "five", shape: "rhombus", hex: "#a855f7", summary: "Fruit (水果)", effect: "鳳梨" },
            { id: "card-int-27", name: "sister", count: 1, value: "five", shape: "rhombus", hex: "#a855f7", summary: "Family (家人)", effect: "姊妹" },
            { id: "card-int-28", name: "marker", count: 1, value: "five", shape: "rhombus", hex: "#a855f7", summary: "School Supply (文具)", effect: "彩色筆" },
            { id: "card-int-29", name: "dress", count: 1, value: "five", shape: "rhombus", hex: "#a855f7", summary: "Clothing (衣物)", effect: "洋裝" },
            { id: "card-int-30", name: "scooter", count: 1, value: "five", shape: "rhombus", hex: "#a855f7", summary: "Transportation (交通)", effect: "機車" },

            // ==================== Trapezoid (Orange, "six") ====================
            { id: "card-int-31", name: "deer", count: 1, value: "six", shape: "trapezoid", hex: "#f97316", summary: "Animal (動物)", effect: "鹿" },
            { id: "card-int-32", name: "mango", count: 1, value: "six", shape: "trapezoid", hex: "#f97316", summary: "Fruit (水果)", effect: "芒果" },
            { id: "card-int-33", name: "uncle", count: 1, value: "six", shape: "trapezoid", hex: "#f97316", summary: "Family (家人)", effect: "叔叔伯伯" },
            { id: "card-int-34", name: "crayon", count: 1, value: "six", shape: "trapezoid", hex: "#f97316", summary: "School Supply (文具)", effect: "蠟筆" },
            { id: "card-int-35", name: "cook", count: 1, value: "six", shape: "trapezoid", hex: "#f97316", summary: "Job (職業)", effect: "廚師" },
            { id: "card-int-36", name: "taxi", count: 1, value: "six", shape: "trapezoid", hex: "#f97316", summary: "Transportation (交通)", effect: "計程車" },

            // ==================== Ellipse (Pink, "seven") ====================
            { id: "card-int-37", name: "papaya", count: 1, value: "seven", shape: "ellipse", hex: "#ec4899", summary: "Fruit (水果)", effect: "木瓜" },
            { id: "card-int-38", name: "aunt", count: 1, value: "seven", shape: "ellipse", hex: "#ec4899", summary: "Family (家人)", effect: "阿姨姑姑" },
            { id: "card-int-39", name: "salad", count: 1, value: "seven", shape: "ellipse", hex: "#ec4899", summary: "Food (食物)", effect: "沙拉" },
            { id: "card-int-40", name: "singer", count: 1, value: "seven", shape: "ellipse", hex: "#ec4899", summary: "Job (職業)", effect: "歌手" },
            { id: "card-int-41", name: "jacket", count: 1, value: "seven", shape: "ellipse", hex: "#ec4899", summary: "Clothing (衣物)", effect: "夾克" },
            { id: "card-int-42", name: "metro", count: 1, value: "seven", shape: "ellipse", hex: "#ec4899", summary: "Transportation (交通)", effect: "捷運" },

            // ==================== Pentagon (Cyan, "eight") ====================
            { id: "card-int-43", name: "glue", count: 1, value: "eight", shape: "pentagon", hex: "#06b6d4", summary: "School Supply (文具)", effect: "膠水" },
            { id: "card-int-44", name: "cheese", count: 1, value: "eight", shape: "pentagon", hex: "#06b6d4", summary: "Food (食物)", effect: "起司" },
            { id: "card-int-45", name: "nurse", count: 1, value: "eight", shape: "pentagon", hex: "#06b6d4", summary: "Job (職業)", effect: "護士" },
            { id: "card-int-46", name: "gloves", count: 1, value: "eight", shape: "pentagon", hex: "#06b6d4", summary: "Clothing (衣物)", effect: "手套" },
            { id: "card-int-47", name: "ship", count: 1, value: "eight", shape: "pentagon", hex: "#06b6d4", summary: "Transportation (交通)", effect: "大船" },
            { id: "card-int-48", name: "sweater", count: 1, value: "eight", shape: "pentagon", hex: "#06b6d4", summary: "Clothing (衣物)", effect: "毛衣" },
